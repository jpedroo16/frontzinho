  ...
  return (
    <ScrollView style={estilo.container}>
      ...
      <View style={estilo.contentContainer}>
        <Text style={estilo.mainTitle}>Guia de Vestibulares 2024</Text>
        ...
        <View style={estilo.section}>
          <Text style={estilo.sectionTitle}>ENEM</Text>
          <Text style={estilo.sectionSubtitle}>Exame Nacional do Ensino Médio</Text>

          <View style={estilo.sectionContent}>
        ...
        {/* Seção Fuvest */}
        <View style={estilo.section}>
          <Text style={estilo.sectionTitle}>Fuvest</Text>
          <Text style={estilo.sectionSubtitle}>Fundação Universitária para o Vestibular (USP)</Text>
          ...
          <View style={estilo.sectionContent}>
            ...
            <Text style={estilo.textos}>
              As inscrições são realizadas entre agosto e setembro, com taxa de inscrição de aproximadamente R$ 200,00. Há isenção para estudantes de baixa renda.
            </Text>
            <Pressable
        ...
        {/* Seção Comvest */}
        <View style={estilo.section}>
          <Text style={estilo.sectionTitle}>Unicamp</Text>
          <Text style={estilo.sectionSubtitle}>Comissão Permanente para os Vestibulares (Comvest)</Text>
          ...
          <View style={estilo.sectionContent}>
            ...
            <Text style={estilo.textos}>
              A taxa de inscrição é de cerca de R$ 190,00. A universidade oferece isenção da taxa para estudantes de baixa renda e candidatos que cursaram o ensino médio em escolas públicas.
            </Text>
            <Pressable
        ...
        {/* Seção Vunesp */}
        <View style={estilo.section}>
          <Text style={estilo.sectionTitle}>Vunesp</Text>
          <Text style={estilo.sectionSubtitle}>Vestibular da Unesp</Text>
          ...
          <View style={estilo.sectionContent}>
            ...
            <Text style={estilo.textos}>
              As inscrições acontecem entre agosto e outubro. A taxa de inscrição é de aproximadamente R$ 180,00, com possibilidade de isenção.
            </Text>
            <Pressable
